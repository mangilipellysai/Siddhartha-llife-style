...
ytcfg.set({
    "EXPERIMENT_FLAGS": {
        ...
        "image_wiz_migration": true,
        "json_condensed_response": true,
        "kev_adb_pg": true,
        "kevlar_default_load_cached_thumbnail": true,
    ...
    "INNERTUBE_CLIENT_VERSION": "2.20250228.01.00",
    "INNERTUBE_CONTEXT": {
        "client": {
            "hl": "en",
            "gl": "IN",
    ...
    "INNERTUBE_CONTEXT_CLIENT_VERSION": "2.20250228.01.00",
...
if (self.trustedTypes && self.trustedTypes.createPolicy) {
    var policy = self.trustedTypes.createPolicy('youtubeServiceWorkerPolicy', {
        createScriptURL: function(unused) {
            return 'https:\/\/www.youtube.com\/s\/desktop\/f72bfc7f\/jsbin\/serviceworker-kevlar-appshell.vflset\/serviceworker-kevlar-appshell.js';
        }
    });
    importScripts(policy.createScriptURL(''));
} else {
    importScripts('https:\/\/www.youtube.com\/s\/desktop\/f72bfc7f\/jsbin\/serviceworker-kevlar-appshell.vflset\/serviceworker-kevlar-appshell.js');
}
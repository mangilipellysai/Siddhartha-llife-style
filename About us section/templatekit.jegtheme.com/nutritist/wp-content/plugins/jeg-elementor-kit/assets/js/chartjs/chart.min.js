...
! function(t, e) {
    ...
    let Vt;
    const Bt = /^rgba?\(\s*([-+.\d]+)(%)?[\s,]+([-+.e\d]+)(%)?[\s,]+([-+.e\d]+)(%)?(?:[\s,/]+([-+.e\d]+)(%)?)?\s*\)$/,
        Nt = t => t <= .0031308 ? 12.92 * t : 1.055 * Math.pow(t, 1 / 2.4) - .055,
        Wt = t => t <= .04045 ? t / 12.92 : Math.pow((t + .055) / 1.055, 2.4);

    function jt(t, e, i) {
        if (t) {
            let s = Lt(t);
            s[e] = Math.max(0, Math.min(s[e] + s[e] * i, 0 === e ? 360 : 1)), s = Rt(s), t.r = s[0], t.g = s[1], t.b = s[2]
        }
    }
    ...
    class Ut {
        constructor(t) {
            ...
            let i;
            var s, n, o;
            "object" === e ? i = $t(t) : "string" === e && (o = (s = t).length, "#" === s[0] && (4 === o || 5 === o ? n = {
                r: 255 & 17 * Mt[s[1]],
                g: 255 & 17 * Mt[s[2]],
                b: 255 & 17 * Mt[s[3]],
                a: 5 === o ? 17 * Mt[s[4]] : 255
        ...
        rotate(t) {
            return function(t, e) {
                var i = Lt(t);
                i[0] = It(i[0] + e), i = Rt(i), t.r = i[0], t.g = i[1], t.b = i[2]
            }(this._rgb, t), this
        }
    }
    ...
    function Gt(t) {
        return qt(t) ? t : Xt(t).saturate(.5).darken(.1).hexString()
    }
    ...
    function be(t, e, i, n) {
        ...
        for (h = 0; h < l; h++)
            ...
            for (c = 0, d = u.length; c < d; c++) f = u[c], null == f || s(f) || (r = me(t, o, a, r, f));
        t.restore();
        const g = a.length / 2;
        if (g > i.length) {
    ...
    function De(t, e, n, o, a, r = {}) {
        ...
        for (t.save(), t.font = a.string, function(t, e) {
            ...
            }(t, r), c = 0; c < l.length; ++c) d = l[c], h && (r.strokeColor && (t.strokeStyle = r.strokeColor), i(r.strokeWidth) || (t.lineWidth = r.strokeWidth), t.strokeText(d, n, o, r.maxWidth)), t.fillText(d, n, o, r.maxWidth), Oe(t, n, o, d, r), o += a.lineHeight;
        t.restore()
    }
    ...
    function Ae(t, e = [""], i = t, s, n = (() => t[0])) {
        ...
        return new Proxy(o, {
            ...
            get: (i, s) => Ie(i, s, (() => function(t, e, i, s) {
                let n;
                for (const o of e)
                    if (n = We(Ee(o, t), i), M(n)) return Re(t, n) ? Be(i, s, t, n) : n
            }(s, e, t, i))),
        ...
        return new Proxy(a, {
            ...
            get: (t, e, i) => Ie(t, e, (() => function(t, e, i) {
                ...
                return k(h) && l.isScriptable(e) && (h = function(t, e, i, s) {
                    ...
                    return r.add(t), e = e(o, a || s), r.delete(t), Re(t, e) && (e = Be(n._scopes, n, t, e)), e
                    ...
                    return e
                }(e, h, t, l.isIndexable)), Re(e, h) && (h = Te(h, a, r && r[e], l)), h
            }(t, e, i))),
    ...
    const Ee = (t, e) => t ? t + w(e) : e,
        Re = (t, e) => n(e) && "adapters" !== t && (null === Object.getPrototypeOf(e) || e.constructor === Object);
    ...
    function Be(t, e, i, o) {
        ...
        return null !== c && (!M(r) || r === i || (c = Ne(h, l, r, c, o), null !== c)) && Ae(Array.from(h), [""], a, r, (() => function(t, e, i) {
    ...
    function qe(t, e = "x") {
        ...
        for (a = 0; a < s; ++a)
            ...
            for (let c = 0; c < s - 1; ++c) l = h, h = Ye(t, c + 1), l && h && (N(e[c], 0, $e) ? i[c] = i[c + 1] = 0 : (n = i[c] / e[c], o = i[c + 1] / e[c], r = Math.pow(n, 2) + Math.pow(o, 2), r <= 9 || (a = 3 / Math.sqrt(r), i[c] = n * a * e[c], i[c + 1] = o * a * e[c])))
        }(t, n, o),
        function(t, e, i = "x") {
            const s = Ue(i),
                n = t.length;
    ...
    function wi(t, e, i) {
        ...
        let p, m, b, x = !1,
            _ = null;
        for (let t = c, i = c; t <= d; ++t) m = e[t % a], m.skip || (p = h(m[s]), p !== b && (x = l(p, n, o), null === _ && (x || l(n, b, p) && 0 !== r(n, b)) && (_ = 0 === r(p, n) ? t : i), null !== _ && (!x || 0 === r(o, p) || l(o, b, p)) && (g.push(vi({
            start: _,
            end: t,
            loop: u,
            count: a,
    ...
    function Ti(t, e, i, s, n) {
        const o = [];
        return n || t.isPointInArea(e) ? (Ai(t, i, e, (function(i, a, r) {
    ...
    function Yi(t, e, i, s) {
        ...
        for (const r of t) {
            ...
            if (r.horizontal) {
                const s = e.w * h,
                    o = l.size || t.height;
                M(l.start) && (a = l.start), t.fullSize ? $i(t, n.left, a, i.outerWidth - n.right - n.left, o) : $i(t, e.left + l.placed, a, s, o), l.start = a, l.placed += s, a = t.bottom
            } else {
                const s = e.h * h,
                    a = l.size || t.width;
                M(l.start) && (o = l.start), t.fullSize ? $i(t, o, n.top, a, i.outerHeight - n.bottom - n.top) : $i(t, o, e.top + l.placed, a, s), l.start = o, l.placed += s, o = t.right
            }
        }
        e.x = o, e.y = a
    }
    ...
    var Ui = {
        ...
        update(t, e, i, s) {
            ...
            Hi(r.fullSize, g, u, p), Hi(l, g, u, p), Hi(h, g, u, p) && Hi(l, g, u, p),
                function(t) {
                ...
                }(g), Yi(r.leftAndTop, g, u, p), g.x += g.w, g.y += g.h, Yi(r.rightAndBottom, g, u, p), t.chartArea = {
                    left: g.left,
                    top: g.top,
                    right: g.left + g.w,
                    bottom: g.top + g.h,
    ...
    function ts(t, e, i) {
        const s = t.canvas,
            n = new MutationObserver((t => {
                let e = !1;
                for (const i of t) e = e || Qi(i.addedNodes, s), e = e && !Qi(i.removedNodes, s);
                e && i()
            }));
    ...
    function es(t, e, i) {
        const s = t.canvas,
            n = new MutationObserver((t => {
                let e = !1;
                for (const i of t) e = e || Qi(i.removedNodes, s), e = e && !Qi(i.addedNodes, s);
                e && i()
            }));
        return n.observe(document, {
            childList: !0,
        ...
        acquireContext(t, e) {
            ...
            return i && i.canvas === t ? (function(t, e) {
                ...
                if (t.$chartjs = {
                    ...
                    }, i.display = i.display || "block", i.boxSizing = i.boxSizing || "border-box", Gi(n)) {
                    const e = ge(t, "width");
                    void 0 !== e && (t.width = e)
                }
                if (Gi(s))
    ...
    function hs(t) {
        return !ie() || "undefined" != typeof OffscreenCanvas && t instanceof OffscreenCanvas ? qi : ls
    }
    ...
    class fs {
        constructor(t, e, i, s) {
            ...
            this._active = !0, this._fn = t.fn || us[t.type || typeof o], this._easing = ti[t.easing] || ti.linear, this._start = Math.floor(Date.now() + (t.delay || 0)), this._duration = this._total = Math.floor(t.duration), this._loop = !!t.loop, this._target = e, this._prop = i, this._from = o, this._to = s, this._promises = void 0
        }
        active() {
            return this._active
        }
    ...
    class ps {
        ...
        _createAnimations(t, e) {
            ...
            for (r = o.length - 1; r >= 0; --r) {
                ...
                d && d.duration ? (n[l] = c = new fs(d, t, l, h), s.push(c)) : t[l] = h
            }
            return s
        }
        update(t, e) {
    ...
    function ws(t, e) {
        ...
        for (let t = 0; t < d; ++t) {
            ...
            u = (i._stacks || (i._stacks = {}))[h] = ys(n, c, o), u[r] = d, u._top = vs(u, a, !0, s.type), u._bottom = vs(u, a, !1, s.type)
        }
    }
    ...
    class Ds {
        ...
        initialize() {
            ...
            this.configure(), this.linkScales(), t._stacked = _s(t.vScale, t), this.addElements()
        }
        updateIndex(t) {
        ...
        buildOrUpdateElements(t) {
            ...
            this._dataCheck();
            const n = e._stacked;
            e._stacked = _s(e.vScale, e), e.stack !== i.stack && (s = !0, ks(e), e.stack = i.stack), this._resyncElements(t), (s || n !== e._stacked) && ws(this, e._parsed)
        }
        configure() {
    ...
    Ds.defaults = {}, Ds.prototype.datasetElementType = null, Ds.prototype.dataElementType = null;
    class Os {
        constructor() {
    ...
    function Ts(t, e) {
        ...
        if (a > 0) {
            ...
            for (Ls(e, h, c, i(n) ? 0 : r - n, r), t = 0, s = a - 1; t < s; t++) Ls(e, h, c, o[t], o[t + 1]);
    ...
    class Bs extends Os {
        ...
        update(t, e, i) {
            ...
            this._convertTicksToLabels(r ? Rs(this.ticks, a) : this.ticks), this.configure(), this.beforeCalculateLabelRotation(), this.calculateLabelRotation(), this.afterCalculateLabelRotation(), o.display && (o.autoSkip || "auto" === o.source) && (this.ticks = Ts(this, this.ticks), this._labelSizes = null, this.afterAutoSkip()), r && this._convertTicksToLabels(this.ticks), this.beforeFit(), this.fit(), this.afterFit(), this.afterUpdate()
        }
        configure() {
        ...
        calculateLabelRotation() {
            ...
            o = t.offset ? this.maxWidth / i : u / (i - 1), c + 6 > o && (o = u / (i - (t.offset ? .5 : 1)), a = this.maxHeight - zs(t.grid) - e.padding - Fs(t.title, this.chart.options.font), r = Math.sqrt(c * c + d * d), l = $(Math.min(Math.asin(Z((h.highest.height + 6) / o, -1, 1)), Math.asin(Z(a / r, -1, 1)) - Math.asin(Z(d / r, -1, 1)))), l = Math.max(s, Math.min(n, l))), this.labelRotation = l
        }
        ...
        _computeLabelSizes(t, e) {
            ...
            for (l = 0; l < e; ++l) {
                if (u = t[l].label, f = this._resolveTickFontOptions(l), n.font = g = f.string, p = o[g] = o[g] || {
                    ...
                    if (s(u))
                        for (h = 0, c = u.length; h < c; ++h) _ = u[h], i(_) || s(_) || (b = me(n, p.data, p.gc, b, _), x += m)
        ...
        _computeGridLineItems(t) {
            ...
            for (x = 0; x < c; x += A) {
                ...
                _ = Is(this, x, l), void 0 !== _ && (y = xe(i, _, e), h ? v = M = S = D = y : w = k = P = O = y, u.push({
                    tx1: v,
                    ty1: w,
                    tx2: M,
                    ty2: k,
    ...
    class Ns {
        ...
        register(t) {
            ...
            return n in s || (s[n] = t, function(t, e, i) {
                const s = m(Object.create(null), [i ? ee.get(i) : {}, ee.get(e), t.defaults]);
                ee.set(e, s), t.defaultRoutes && function(t, e) {
            ...
            }(t, o, i), this.override && ee.override(t.id, t.overrides)), o
        }
        get(t) {
            return this.items[t]
        }
        unregister(t) {
            const e = this.items,
                i = t.id,
                s = this.scope;
            i in e && delete e[i], s && i in ee[s] && (delete ee[s][i], this.override && delete Zt[i])
        }
    }
    var Ws = new class {
        constructor() {
            this.controllers = new Ns(Ds, "datasets", !0), this.elements = new Ns(Os, "elements"), this.plugins = new Ns(Object, "plugins"), this.scales = new Ns(Bs, "scales"), this._typedRegistries = [this.controllers, this.scales, this.elements]
        }
        add(...t) {
    ...
    class Qs {
        ...
        getOptionScopes(t, e, i) {
            ...
            const r = new Set;
            e.forEach((e => {
                t && (r.add(t), e.forEach((e => Js(r, t, e)))), e.forEach((t => Js(r, s, t))), e.forEach((t => Js(r, Zt[n] || {}, t))), e.forEach((t => Js(r, ee, t))), e.forEach((t => Js(r, Jt, t)))
            }));
            const l = Array.from(r);
            return 0 === l.length && l.push(Object.create(null)), Gs.has(e) && o.set(e, l), l
        }
        chartOptionScopes() {
            const {
                options: t,
        ...
        resolveNamedOptions(t, e, i, n = [""]) {
            ...
            (function(t, e) {
                ...
                return !1
            })(a, e) && (o.$shared = !1, l = Te(a, i = k(i) ? i() : i, this.createResolver(t, i, r)));
    ...
    const en = t => n(t) && Object.getOwnPropertyNames(t).reduce(((e, i) => e || k(t[i])), !1),
    ...
    const hn = {},
        cn = t => {
            const e = ln(t);
            return Object.values(hn).filter((t => t.canvas === e)).pop()
        };
    ...
    class un {
        ...
        buildOrUpdateScales() {
            ...
            e && (n = n.concat(Object.keys(e).map((t => {
                ...
                const n = e.options,
                    ...
                    a = Us(o, n),
                    l = r(n.type, e.dtype);
                void 0 !== n.position && nn(n.position, a) === nn(e.dposition) || (n.position = e.dposition), s[o] = !0;
                let h = null;
                o in i && i[o].type === l ? h = i[o] : (h = new(Ws.getScale(l))({
                    id: o,
                    type: l,
                    ctx: this.ctx,
                    chart: this
        ...
        buildOrUpdateControllers() {
            ...
            for (this._removeUnreferencedMetasets(), i = 0, s = e.length; i < s; i++) {
                ...
                if (n.type && n.type !== o && (this._destroyDatasetMeta(i), n = this.getDatasetMeta(i)), n.type = o, n.indexAxis = s.indexAxis || Ys(o, this.options), n.order = s.order || 0, n.index = i, n.label = "" + s.label, n.visible = this.isDatasetVisible(i), n.controller) n.controller.updateIndex(i), n.controller.linkScales();
                else {
        ...
        _updateHiddenIndices() {
            ...
            for (const {
                    ...
                    start: s,
                    count: n
                } of e) dn(t, s, "_removeElements" === i ? -n : n)
        }
        ...
        render() {
            !1 !== this.notifyPlugins("beforeRender", {
                cancelable: !0
            }) && (mt.has(this) ? this.attached && !mt.running(this) && mt.start(this) : (this.draw(), an({
                chart: this
            })))
        }
        draw() {
        ...
        destroy() {
            ...
            this._stop(), this.config.clearCache(), t && (this.unbindEvents(), _e(t, e), this.platform.releaseContext(e), this.canvas = null, this.ctx = null), this.notifyPlugins("destroy"), delete hn[this.id], this.notifyPlugins("afterDestroy")
        }
        toBase64Image(...t) {
    ...
    function yn(t, e, i, s) {
        const n = t.iScale,
            ...
            l = [];
        let h, c, d, u;
        for (h = i, c = i + s; h < c; ++h) u = e[h], d = {}, d[n.axis] = r || n.parse(a[h], h), l.push(_n(u, d, o, h));
        return l
    }
    ...
    function wn(t, e, i, s) {
        ...
        "middle" === n && i && (t.enableBorderRadius = !0, (i._top || 0) === s ? n = h : (i._bottom || 0) === s ? n = c : (o[Mn(c, a, r, l)] = !0, n = h)), o[Mn(n, a, r, l)] = !0, t.borderSkipped = o
    }

    function Mn(t, e, i, s) {
        var n, o, a;
        return s ? (a = i, t = kn(t = (n = t) === (o = e) ? a : n === a ? o : n, i, e)) : t = kn(t, e, i), t
    }
    ...
    class Pn extends Ds {
        ...
        parseObjectData(t, e, i, s) {
            ...
            let d, u, f, g;
            for (d = i, u = i + s; d < u; ++d) g = e[d], f = {}, f[n.axis] = n.parse(y(g, l), d), c.push(_n(y(g, h), f, o, d));
            return c
        }
        updateRangeFromParsed(t, e, i, s) {
        ...
        _calculateBarValuePixels(t) {
            ...
            } = this, a = n || 0, r = this.getParsed(t), l = r._custom, h = vn(l);
            let c, d, u = r[e.axis],
                f = 0,
    ...
    class En extends Ds {
        ...
        addElements() {
            ...
            !this.datasetElementType && t && (this.datasetElementType = Ws.getElement("line")), super.addElements()
        }
        updateElements(t, e, s, n) {
            const o = "reset" === n,
                {
        ...
        draw(t) {
            ...
            (function(t, e, i, s, n, o) {
                ...
                r && (h ? (t.lineWidth = 2 * r, t.lineJoin = l || "round") : (t.lineWidth = r, t.lineJoin = l || "bevel"), e.fullCircles && function(t, e, i) {
                    ...
                    let c;
                    for (i && In(t, e, o + O), t.beginPath(), t.arc(s, n, h, o + O, o, !0), c = 0; c < r; ++c) t.stroke();
                    for (t.beginPath(), t.arc(s, n, l, o, o + O), c = 0; c < r; ++c) t.stroke()
                }(t, e, h), h && In(t, e, n), Fn(t, e, i, s, n, o), t.stroke())
    ...
    function jn(t, e, i, s) {
        const {
            ...
            return t.stepped ? Se : t.tension || "monotone" === t.cubicInterpolationMode ? Pe : Nn
        }(o);
        let d, u, f, {
            move: g = !0,
            reverse: p
    ...
    function $n(t) {
        ...
        return t._decimated || t._loop || e.tension || "monotone" === e.cubicInterpolationMode || e.stepped || i ? jn : Hn
    }
    ...
    class Un extends Os {
        ...
        draw(t, e, i, s) {
            ...
            (this.points || []).length && n.borderWidth && (t.save(), function(t, e, i, s) {
                Yn && !e.options.segment ? function(t, e, i, s) {
                    let n = e._path;
    ...
    function Zn(t) {
        const e = Kn(t),
            ...
            a = function(t, e, i) {
                ...
                } = t.getProps(["enableBorderRadius"]), o = t.options.borderRadius, a = di(o), r = Math.min(e, i), l = t.borderSkipped, h = s || n(o);
                return {
    ...
    class eo extends Os {
        ...
        draw(t) {
            const {
                ...
                inner: n,
                outer: o
            } = Zn(this), a = (r = o.radius).topLeft || r.topRight || r.bottomLeft || r.bottomRight ? Ce : Qn;
            var r;
    ...
    function xo(t, e, i) {
        ...
        s && n.points.length && (Me(t, i), function(t, e) {
            ...
            t.save(), "x" === l && o !== n && (_o(t, s, a.top), yo(t, {
                line: i,
                target: s,
                color: n,
                scale: r,
                property: l
            }), t.restore(), t.save(), _o(t, s, a.bottom)), yo(t, {
                line: i,
                target: s,
                color: o,
                scale: r,
            ...
            for (const t of s) {
                ...
                for (const e of h) {
                    ...
                    for (const t of r) a.push({
                        ...
                        target: e,
                        start: {
                            [i]: lo(l, s, "start", Math.max)
                        },
                        end: {
                            [i]: lo(l, s, "end", Math.min)
                        }
                    })
                }
            }
    ...
    var Mo = {
        ...
        beforeDraw(t, e, i) {
            ...
            for (let e = n.length - 1; e >= 0; --e) {
                const i = n[e].$filler;
                i && (i.line.updateControlPoints(o, i.axis), s && i.fill && xo(t.ctx, i, o))
            }
        },
    ...
    class So extends Os {
        ...
        _draw() {
            const {
                ...
                align: n,
                labels: o
            } = t, a = ee.color, l = bi(t.rtl, this.left, this.width), h = fi(o.font), {
                color: c,
                padding: d
            } = o, u = h.size, f = u / 2;
            let g;
            ...
            const {
                ...
                boxHeight: m,
                itemHeight: b
            } = ko(o, u), x = this.isHorizontal(), _ = this._computeTitleHeight();
            g = x ? {
        ...
        drawTitle() {
            ...
            const u = ut(a, c, c + d);
            o.textAlign = n.textAlign(dt(a)), o.textBaseline = "middle", o.strokeStyle = e.color, o.fillStyle = e.color, o.font = i.string, De(o, e.text, u, h, i)
        }
        _computeTitleHeight() {
    ...
    function Io(t, e) {
        ...
        x += t.beforeBody.length + t.afterBody.length, u && (m += u * h.lineHeight + (u - 1) * e.titleSpacing + e.titleMarginBottom), x && (m += g * (e.displayColors ? Math.max(r, l.lineHeight) : l.lineHeight) + (x - g) * l.lineHeight + (x - 1) * e.bodySpacing), f && (m += e.footerMarginTop + f * c.lineHeight + (f - 1) * e.footerSpacing);
        let _ = 0;
        const y = function(t) {
    ...
    class jo extends Os {
        ...
        getBody(t, e) {
            ...
            return d(t, (t => {
                const e = {
                    ...
                    n = Wo(i, t);
                Lo(e.before, Eo(n.beforeLabel.call(this, t))), Lo(e.lines, n.label.call(this, t)), Lo(e.after, Eo(n.afterLabel.call(this, t))), s.push(e)
            })), s
        }
        getAfterBody(t, e) {
        ...
        drawTitle(t, e, i) {
            ...
            if (n) {
                ...
                for (t.x = Bo(this, i.titleAlign, i), e.textAlign = l.textAlign(i.titleAlign), e.textBaseline = "middle", o = fi(i.titleFont), a = i.titleSpacing, e.fillStyle = i.titleColor, e.font = o.string, r = 0; r < n; ++r) e.fillText(s[r], l.x(t.x), t.y + o.lineHeight / 2), t.y += o.lineHeight + a, r + 1 === n && (t.y += i.titleMarginBottom - a)
            }
        }
        _drawColorBox(t, e, i, s, o) {
            ...
            if (o.usePointStyle) {
                const e = {
                    ...
                    n = p + l / 2;
                t.strokeStyle = o.multiKeyBackground, t.fillStyle = o.multiKeyBackground, ye(t, e, i, n), t.strokeStyle = a.borderColor, t.fillStyle = a.backgroundColor, ye(t, e, i, n)
            } else {
                ...
                const e = s.leftForLtr(f, h - c),
                    ...
                    r = di(a.borderRadius);
                Object.values(r).some((t => 0 !== t)) ? (t.beginPath(), t.fillStyle = o.multiKeyBackground, Ce(t, {
                    x: e,
                    y: p,
                    w: h,
                    h: l,
        ...
        drawBody(t, e, i) {
            ...
            const g = bi(i.rtl, this.x, this.width),
                ...
                m = g.textAlign(o);
            let b, x, _, y, v, w, M;
            for (e.textAlign = o, e.textBaseline = "middle", e.font = c.string, t.x = Bo(this, m, i), e.fillStyle = i.bodyColor, d(this.beforeBody, p), f = a && "right" !== m ? "center" === o ? l / 2 + h : l + 2 + h : 0, y = 0, w = s.length; y < w; ++y) {
        ...
        drawFooter(t, e, i) {
            ...
            if (n) {
                ...
                for (t.x = Bo(this, i.footerAlign, i), t.y += i.footerMarginTop, e.textAlign = r.textAlign(i.footerAlign), e.textBaseline = "middle", o = fi(i.footerFont), e.fillStyle = i.footerColor, e.font = o.string, a = 0; a < n; ++a) e.fillText(s[a], r.x(t.x), t.y + o.lineHeight / 2), t.y += o.lineHeight + i.footerSpacing
            }
        }
    ...
    class Yo extends Bs {
        ...
        parse(t, e) {
            ...
            return ((t, e) => null === t ? null : Z(Math.round(t), 0, e))(e = isFinite(e) && s[e] === t ? e : function(t, e, i, s) {
                const n = t.indexOf(e);
                return -1 === n ? ((t, e, i, s) => ("string" == typeof e ? (i = t.push(e) - 1, s.unshift({
                    index: i,
                    label: e
                })) : isNaN(e) && (i = null), i))(t, e, i, s) : n !== t.lastIndexOf(e) ? i : n
            }(s, t, r(e, t), this._addedLabels), s.length - 1)
        }
        determineDataLimits() {
            const {
                minDefined: t,
    ...
    Yo.id = "category", Yo.defaults = {
        ticks: {
            callback: Yo.prototype.getLabelForValue
        }
    };
    class Xo extends Bs {
        constructor(t) {
        ...
        buildTicks() {
            ...
            const n = function(t, e) {
                ...
                for (b && (u && w !== a ? (s.push({
                        value: a
                    }), w < a && D++, N(Math.round((w + D * S) * v) / v, a, Uo(a, y, t)) && D++) : w < a && D++); D < k; ++D) s.push({
                    value: Math.round((w + D * S) * v) / v
                });
                return x && u && M !== r ? s.length && N(s[s.length - 1].value, r, Uo(r, y, t)) ? s[s.length - 1].value = r : s.push({
                    value: r
                }) : x && M !== r || s.push({
                    value: M
                }), s
    ...
    qo.id = "linear", qo.defaults = {
        ticks: {
            callback: As.formatters.numeric
        }
    };
    class Go extends Bs {
        constructor(t) {
    ...
    Go.id = "logarithmic", Go.defaults = {
        ticks: {
            callback: As.formatters.logarithmic,
            major: {
                enabled: !0
            }
        }
    ...
    class na extends Xo {
        ...
        drawBackground() {
            ...
            if (t) {
                const i = this.ctx;
                i.save(), i.beginPath(), sa(this, this.getDistanceFromCenterForValue(this._endValue), e, this._pointLabels.length), i.closePath(), i.fillStyle = t, i.fill(), i.restore()
            }
        }
        drawGrid() {
            const t = this.ctx,
            ...
            if (e.pointLabels.display && function(t, e) {
                    ...
                    for (let o = e - 1; o >= 0; o--) {
                        ...
                        if (!i(g)) {
                            ...
                            const n = c - i.left,
                                ...
                                a = u - c + i.width,
                                r = f - d + i.height;
                            Object.values(t).some((t => 0 !== t)) ? (s.beginPath(), Ce(s, {
                                x: n,
                                y: o,
                                w: a,
                                h: r,
                    ...
                    0 !== e && (r = this.getDistanceFromCenterForValue(t.value), function(t, e, i, s) {
                        ...
                        !o && !s || !a || !r || i < 0 || (n.save(), n.strokeStyle = a, n.lineWidth = r, n.setLineDash(e.borderDash), n.lineDashOffset = e.borderDashOffset, n.beginPath(), sa(t, i, o, s), n.closePath(), n.stroke(), n.restore())
    ...
    na.id = "radialLinear", na.defaults = {
        display: !0,
        animate: !0,
        position: "chartArea",
        angleLines: {
    ...
    class ua extends Bs {
        ...
        buildTicks() {
            ...
            const n = this.min,
                o = st(s, n, this.max);
            return this._unit = e.unit || (i.autoSkip ? ha(e.minUnit, this.min, this.max, this._getLabelCapacity(n)) : function(t, e, i, s, n) {
                for (let o = aa.length - 1; o >= aa.indexOf(i); o--) {
                    const i = aa[o];
                    if (oa[i].common && t._adapter.diff(n, s, i) >= e - 1) return i
                }
            ...
            }(this._unit) : void 0, this.initOffsets(s), t.reverse && o.reverse(), da(this, o, this._majorUnit)
        }
        afterAutoSkip() {
        ...
        _generate() {
            ...
            return d !== i && "ticks" !== s.bounds && 1 !== u || ca(c, d, g), Object.keys(c).sort(((t, e) => t - e)).map((t => +t))
        }
        getLabelForValue(t) {

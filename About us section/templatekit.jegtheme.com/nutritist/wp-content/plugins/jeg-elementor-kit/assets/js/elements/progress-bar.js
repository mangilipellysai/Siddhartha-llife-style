! function(e) {
    ...
    class n extends elementorModules.frontend.handlers.Base {
        ...
        getDefaultElements() {
            ...
            return {
                ...
                $skill: this.$element.find(e.skill),
        ...
        onLoadElement() {
            this.countNumber(), jQuery(window).on("scroll", this.countNumber.bind(this))
        }
        countNumber() {
            const e = this.elements.$number,
                t = this.elements.$skill;
            this.onScreen() && !e.hasClass("loaded") && (e.prop("Counter", 0).animate({
                ...
                easing: "swing",
                step: function(n) {
                    e.text(Math.ceil(n).toString() + "%"), t.css("width", n.toString() + "%")
                }
            }), e.addClass("loaded"))
        }
        onScreen() {
    ...
    jQuery(window).on("elementor/frontend/init", (() => {
        elementorFrontend.hooks.addAction("frontend/element_ready/jkit_progress_bar.default", (e => {
